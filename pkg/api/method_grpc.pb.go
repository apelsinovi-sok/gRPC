...
func (c *methodClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/api.Method/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMethodServer must be embedded to have forward compatible implementations.
type UnimplementedMethodServer struct {
}

func (UnimplementedMethodServer) Add(context.Context, *AddRequest) (*AddResponse, error) {
...
var Method_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/method.proto",
}
